...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
	<div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
		<a class="flex items-center space-x-3 rtl:space-x-reverse" href="/">
			<img alt="Tesla Logo" class="h-8" src="https://upload.wikimedia.org/wikipedia/commons/b/bd/Tesla_Motors.svg" />
		...
		<div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
			...
			{:else }
				...
				<button aria-controls="mega-menu-icons" aria-expanded="false"
								class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
								data-collapse-toggle="mega-menu-icons" type="button">
		...
		<div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mega-menu-icons">
			<ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
				...
				<li>
					...
					<div
						...
						<div class="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
							<ul aria-labelledby="mega-menu-icons-dropdown-button" class="space-y-4">
								<li>
									<a
				...
				{#if user}
					...
					<li>
						<a
							class="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
							href="/price">Electricity prices</a>
					</li>
				{/if}
			</ul>
		</div>
